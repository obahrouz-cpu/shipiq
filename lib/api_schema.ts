...
export const API_ENDPOINTS: ApiEndpoint[] = [
  ...
  // ── Pricing Engine ────────────────────────────────────────────────────────
  {
    ...
    response: {
      ...
      billableWeight: 'number (raw total, converted to weightUnit, × qty)',
      effectiveWeight: 'number (billableWeight floored at min_billable_weight — the weight ACTUALLY billed; show this)',
      shipping: 'number? (= effectiveWeight × rate; null when ratesUnavailable — rate not set yet / TBD)',
